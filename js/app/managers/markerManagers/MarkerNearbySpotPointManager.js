(function(global) {
    ...
    MyApp.MarkerNearbySpotPointManager = class MarkerNearbySpotPointManager {
        ...
        _createCoreManager(targetTimeRangeType, targetUrl) {
            ...
            var callbacks = {
                'tooltipContentCallback': MarkerNearbySpotPointManager._buildTooltipContent,
                'popupContentCallback': null,
                'filterGeojsonPredicate': MarkerNearbySpotPointManager._filterGeojsonPredicate,
            };
            var options = {
                shouldCircleMarker: false,
                circleMarkerColNames: null,
                shouldTooltip: true,
                tooltipNames: {className: 'tooltip-nearby-spot-point', geZoom: 'placePointTooltipGeZoom', direction: 'placePointTooltipDirection'},
                shouldPopup: false,
                popupNames: null,
                isCustomIconMarker: true,
                customIconUrl: 'images/nearby_spot.png',
            };
...
`;
        ...
        static _filterGeojsonPredicate(properties) {
            if (properties.isNearbySpotPoint === true) {
                return true;
            }
            return false;
        }
